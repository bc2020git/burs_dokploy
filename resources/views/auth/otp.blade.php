        ...
        <div class="col-md-6 right d-flex justify-content-center align-items-center">
            <div class="input-box">
                ...
                <div id="verifyButton" class="input-field-verify">
                    <a href="/admin/index.html"><input type="submit" class="submit-verify" value="Doğrula"></a>
                    <span>Mail almadın mı?  <a href="{{url('public')}}/loginPages/otp-authentication.html">Tekrar gönder</a></span>
                </div>
...
</div>        @include('includes.js.toastr')

<script src="{{url('public')}}/assets/js/loginPages/login.js"></script>
