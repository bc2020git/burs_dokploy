    ...
    <div class="row g-0 vh-100">
        ...
        <div class="col-md-6 right d-flex justify-content-center align-items-center">
            <div class="input-box">
                ...
                <div class="turn-back">
                    <a href="{{route('student.active.login')}}">
                ...
                <form method="POST" action="{{ route('student-password-link-reset') }}"
                @csrf
                ...
                <div class="input-field">
                    <input class='btn btn-info' type="submit" class="submit" value="Gönder">
                </div>
                </form>
                <div class="input-field-verify">
