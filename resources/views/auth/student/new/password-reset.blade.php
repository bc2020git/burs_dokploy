                ...
                <div class="input-box">
                    ...
                    <div class="input-field-verify">
                        ...
                        <div class="email-container">
                            <input type="email" id="email" class="email-input" placeholder="Mail adresinizi Giriniz.."
                                required>
                        </div>
                    </div>
                    <div class="input-field">
                        <a href="/loginPages/send-password-reset.html"><input type="submit" class="submit" value="Gönder"></a>
                    </div>
                    <div class="input-field-verify">
