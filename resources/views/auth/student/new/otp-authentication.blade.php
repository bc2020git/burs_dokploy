        ...
        <div class="row g-0 vh-100">
            ...
            <div class="col-md-6 right d-flex justify-content-center align-items-center">
                <div class="input-box">
                    ...
                    <div class="turn-back"> <a href="{{route('aday.login.view')}}">
                    ...
                    <div class="input-field-verify">
                        ...
                        <div class="input-field-btn">
                            ...
                            <span>Mail almadın mı? <a href="{{route('otptekrargonder')}}">Tekrar gönder</a></span>
                        </div>
...
<script >
    ...
    <script>
        ...
        // Flash mesajlarını kontrol et ve göster
