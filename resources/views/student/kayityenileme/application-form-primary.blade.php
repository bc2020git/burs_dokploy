                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @foreach($cities as $city)
                                                <option data-id="{{ $city->id }}"  @if(isset($aday->educinfo->p_school_city) && $aday->educinfo->p_school_city == $city->id) selected @endif value="{{$city->id}}">{{$city->isim}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
    ...
    @section('scripts')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const pageName = 'kayityenileme'+{{ $scholarid ?? 'primary' }};
                StudentTabManager.init('application-form-primary', pageName);
            });
        </script>
