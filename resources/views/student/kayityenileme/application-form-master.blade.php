                    ...
                    <div class="main-content-manuel">
                        ...
                        <form>
                            ...
                            <div class="step-content" id="step-3" data-content="3">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="universityCity">Üniversitenin Bulunduğu Şehir</label>
    ...
    @section('scripts')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const pageName = 'kayityenileme'+{{ $scholarid ?? 'master' }};
                StudentTabManager.init('application-form-master', pageName);
            });
        </script>
