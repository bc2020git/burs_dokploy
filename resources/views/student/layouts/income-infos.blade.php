...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        <label for="saglayanKisilerToplam" class="form-label">Gelir Sağlayan Kişi/Kişiler Toplam Kaç Kişiye Bakıyor?</label>
...
<div class="row">
    <div class="col-md-6 mb-3">
        <label for="digerKisilerinGeliri" class="form-label">Diğer kişilerin Aylık Net Geliri (TL)</label>
