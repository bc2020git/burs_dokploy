<div class="step-content" id="step-2" data-content="2">
    <div class="row">
        ...
        <label for="day">Doğum Tarihi <span style='color:red' >  *</span></label>
        ...
        <div class="col-md-2 mb-3">
            <select id="month" class="form-select">
                @if(isset($bolunmusTarih))
                    <option required selected value="{{$bolunmusTarih[1]}}">{{$bolunmusTarih[1]}}</option>
                @else
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <select required onchange="getDistricts(this,'birthDistrict')" id="birthCity" class="form-select">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select requrired id="birthDistrict" class="form-select">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select required id="maritalStatus" class="form-select">
                <option value="">Seçiniz...</option>
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <select required id="nationality" class="form-select">
                <option value="">Seçiniz...</option>
