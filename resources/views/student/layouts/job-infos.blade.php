    ...
    <div class="row">
        <div class="col-md-12">
            <div class="form-group mb-3">
                <label for="employment-status">Düzenli olarak bir kurumda kazanç sağlıyor mu?</label>
                <select id="employment-status" class="form-select">
                    <option value="" disabled selected>Seçiniz...</option>
                    <option @selected(isset($aday->job->is_working) && $aday->job->is_working == 'Full-time') value="Full-time">Full-time</option>
                    <option @selected(isset($aday->job->is_working) && $aday->job->is_working == 'Part-time') value="Part-time">Part-time</option>
                    <option @selected(isset($aday->job->is_working) && $aday->job->is_working == 'Stajyer') value="Stajyer">Stajyer</option>
