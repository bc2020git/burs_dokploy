...
@section('body')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select id="schoolType" class="form-select">
                                            <option disabled selected>İlkokul</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="p_school_name">Okul Adı</label>
                                        <input type="text" class="form-control" @if(isset($aday->educinfo->p_school_name)) value="{{$aday->educinfo->p_school_name}}" @endif  id="p_school_name"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @foreach($cities as $city)
                                                <option data-id="{{ $city->id }}"  @if(isset($aday->educinfo->p_school_city) && $aday->educinfo->p_school_city == $city->isim) selected @endif value="{{$city->isim}}">{{$city->isim}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
    ...
    @section('scripts')
        ...
        <script src="{{url('')}}/assets/js/components/student-buttons2.js"></script>
