            ...
            @case('ilkokul')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input id="class" type="number" class="form-control" value="{{$aday->infos->class}}">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select id="current_university" class="form-select">
                            <option @selected(isset($aday->infos->current_university) && $aday->infos->current_university == '{{ $aday->infos->current_university }}') value="{{ $aday->infos->current_university }}">{{ $aday->infos->current_university }}</option>
                        </select>
                    </div>
                    <div class="col-md-6 mb-3 form-group">
            ...
            @case('lisans')
                ...
                <div class="row">
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select id="university_city" class="form-select">
                            @foreach($cities as $city)
                                <option data-id="{{ $city->name }}"  @if( isset($aday->infos->university_city) && $aday->infos->university_city == $city->name) selected @endif value="{{$city->name}}">{{$city->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-6 mb-3 form-group">
                        ...
                        <select id="current_university" class="form-select">
                            <option value="">Seçiniz...</option>
                            @foreach($unis as $u)
                                <option data-id='{{$u->name}}' @selected(isset($aday->infos->current_university) && $aday->infos->current_university == $u->name) value="{{$u->name}}">{{$u->name}}</option>
