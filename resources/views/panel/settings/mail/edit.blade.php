                        ...
                        <form id="bankDetailForm"  class="p-4">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <input id="bankaAdi" name="bankaAdi" type="text" class="form-control" value="{{$bank->name}}">
                                </div>
                                <div class="col-md-12 form-group">
                                    <div class="col-md-12 form-group">
                                        <label for="bankaKodu" class="custom-label">Banka Kodu</label>
                                        <input id="bankaKodu" name="bankaKodu" type="number" class="form-control" value="{{$bank->code}}">
                                    </div>
                                </div>
                            </div>
                        </form>
