                ...
                <div class="navbar-button-container">
                    <div class="d-flex flex-wrap">
                        <button type="button" class="btn me-3 text-white" id="newAdd" data-bs-toggle="tooltip"
                                ...
                                onclick="window.location.href='{{route('add-bank')}}'">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-hover" id="bankTable">
                            ...
                            <th>
                                <div class="dropdown-sort">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton8">
                                        <li><a class="dropdown-item" href="#" onclick="sortTable(8, 'asc')">A'dan
                                                Z'ye</a></li>
                                        <li><a class="dropdown-item" href="#" onclick="sortTable(8, 'desc')">Z'den
                                                A'ya</a></li>
                                    </ul>
                                </div>
                            </th>
                        ...
                        <tbody id="bankTableBody">
                            @foreach($data as $d)
                                <tr>
                                    <td><input data-id="{{$d->id}}" value="{{$d->id}}" type="checkbox" name="userCheckbox" class="checkbox"></td>
                                    <td>{{$d->name}}</td>
                                    <td>{{$d->code}}</td>
                                    <td>
                                        <a href="{{ route('detail-bank', ['id' => $d->id]) }}">
                                            <button class="btn edit-province-info-btn" data-index="0" onclick="location.href='/admin/provinces-details.html'"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none">
