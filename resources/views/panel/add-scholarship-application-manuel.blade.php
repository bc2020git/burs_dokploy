...
@endsection
    @section('content')
        <main class="main-content px-3 py-4">
            <form id="manuelscholarform" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="formtipi" id="formtipi" value="{{$formType}}">
                <div class=" mt-1">

                    <div class="navbar-button-container">
                        <p class="btn btn-outline-primary" id="saveAndClose">
                        ...
                        <button type="button" class="btn me-3 btn-outline-warning" id="sms"
                            onclick="window.location.href='/admin/send-sms.html' ">
                        ...
                        <div class="col-md-12">
                            <div class="scroll">
                                <ul class="nav nav-tabs d-flex flex-nowrap custom-nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item custom-nav-item" role="presentation">
                                        <button class="nav-link custom-nav-link" id="place-info" data-bs-toggle="tab"
                                    ...
                                    <li class="nav-item custom-nav-item" role="presentation">
                                        <button class="nav-link custom-nav-link" id="interview-info-tab"
                                            data-bs-toggle="tab" data-bs-target="#interview-info" type="button" role="tab"
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="general-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                    <label class="custom-label">Aday Dönemi</label><span style="color: red">
                                                        * </span>
                                                    <select id="period_id" class="form-select">
                                                        <option value="">Seçiniz</option>
                                                        @foreach(($periods ?? []) as $pOption)
                                                            <option value="{{ $pOption->id }}">{{ $pOption->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control date-input" id="b_dob"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select id="nationality" class="form-select">
                                                            <option selected disabled value="seçiniz">Seçiniz..</option>
                                                            <option value="türk">Türkiye</option>
                                            ...
                                            <div class="tab-section">
                                                ...
                                                <div id="ilkokuldiv" class="educdiv d-none">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input id="student_number" type="text" class="form-control"
                                                                value="">
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                            <label class="custom-label">Not Ortalaması</label>
                                                            <input id="grade_avg" type="text" class="form-control"
                                                                value=" ">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input id="is_transfered" type="text" class="form-control"
                                                                value="">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div id="ortaokuldiv" class="educdiv d-none">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="m_school_district" class="form-select">
                                                                ...
                                                                {{$aday->educinfo->m_school_district}}</option>@endif
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input
                                                                value="@if(isset($aday->educinfo->student_number)) {{$aday->educinfo->student_number}}@endif"
                                                                type="text" class="form-control" id="student_number"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input
                                                                value="@if(isset($aday->educinfo->student_number)) {{$aday->educinfo->grade_avg}}@endif"
                                                                type="text" class="form-control" id="student_number"
                                                ...
                                                <div id="lisediv" class="educdiv d-none">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select onchange="getDistricts(this,'h_school_district')"
                                                                ...
                                                                @foreach($cities as $city)
                                                                    <option data-id="{{ $city->id }}"
                                                                        @if(isset($aday->educinfo->h_school_city) && $aday->educinfo->m_school_city == $city->id) selected
                                                                        @endif value="{{$city->id}}">{{$city->isim}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input @if(isset($aday->educinfo->grade_avg))
                                                            value="{{$aday->educinfo->grade_avg}}" @endif type="text"
                                                                class="form-control" id="averageGrade"
                                                                placeholder="Not ortalamanızı giriniz...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="onlisansdiv" class="educdiv d-none">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input @if(isset($aday->educinfo->grade_high_school))
                                                            value="{{$aday->educinfo->grade_high_school}}" @endif
                                                                type="text" class="form-control" id="grade_high_school"
                                                                placeholder="Lise bilgisi giriniz...">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="entry_grade_university">Üniversiteye Giriş
                                                                Puanınız</label>
                                                            <input @if(isset($aday->educinfo->entry_grade_university))
                                                            value="{{$aday->educinfo->entry_grade_university}}" @endif
                                                                type="text" class="form-control" id="entry_grade_university"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="current_university">Öğrenime Devam Ettiğiniz
                                                                Üniversite</label>
                                                            <input @if(isset($aday->educinfo->current_university))
                                                            value="{{$aday->educinfo->current_university}}" @endif
                                                                type="text" class="form-control" id="current_university"
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="university_type" class="form-select">
                                                                <option value="">Seçiniz...</option>
                                                                <option @selected(isset($aday->educinfo->university_type) && $aday->educinfo->university_type == 'Devlet')
                                                                    value="Devlet">Devlet</option>
                                                                <option @selected(isset($aday->educinfo->university_type) && $aday->educinfo->university_type == 'Vakıf/Özel')
                                                                    value="Vakıf/Özel">Vakıf/Özel</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="university_city" class="form-select">
                                                                <option selected disabled value="seçiniz">Seçiniz..</option>
                                                                @foreach($cities as $city)
                                                                    <option data-id="{{ $city->id }}" @if(isset($aday->educinfo->university_city) && $aday->educinfo->university_city == $city->isim) selected
                                                                    @endif value="{{$city->isim}}">{{$city->isim}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label for="educationYear">{{$period->title}} Öğretim Yılında
                                                                Kaçıncı Sınıfta
                                                                Olacaksınız?</label>
                                                            <select id="university_class" class="form-select">
                                                                <option selected disabled value="">Seçiniz...</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == 'Hazırlık')
                                                                    value="Hazırlık">Hazırlık</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '1.Sınıf')
                                                                    value="1.Sınıf">1.Sınıf</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '2.Sınıf')
                                                                    value="2.Sınıf">2.Sınıf</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '3.Sınıf')
                                                                    value="3.Sınıf">3.Sınıf</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '4.Sınıf')
                                                                    value="4.Sınıf">4.Sınıf</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '5.Sınıf')
                                                                    value="5.Sınıf">5.Sınıf</option>
                                                                <option @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '6.Sınıf')
                                                                    value="6.Sınıf">6.Sınıf</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="university_educ_time" class="form-select">
                                                                <option value="">Seçiniz...</option>
                                                                <option
                                                                    @selected(isset($aday->educinfo->university_educ_time) && $aday->educinfo->university_educ_time == '2')
                                                                    value="2">2</option>
                                                                <option
                                                                    @selected(isset($aday->educinfo->university_educ_time) && $aday->educinfo->university_educ_time == '4')
                                                                    value="4">4</option>
                                                                <option
                                                                    @selected(isset($aday->educinfo->university_educ_time) && $aday->educinfo->university_educ_time == '6')
                                                                    value="6">6</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="agnoSystem" class="form-select">
                                                                <option value="">Seçiniz...</option>
                                                                <option @selected(isset($aday->educinfo->agno_type) && $aday->educinfo->agno_type == "4'lük") value="4'lük">4'lük
                                                                </option>
                                                                <option @selected(isset($aday->educinfo->agno_type) && $aday->educinfo->agno_type == "100'lük") value="100'lük">
                                                                    100'lük</option>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input
                                                                value="@if(isset($aday->educinfo->agno)) {{$aday->educinfo->agno}} @endif"
                                                                type="text" class="form-control" id="agno"
                                                                placeholder="Not ortalamanızı giriniz...">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="university_transfer" class="form-select">
                                                                <option value="">Seçiniz...</option>
                                                                <option value="Evet"
                                                                    @selected(isset($aday->educinfo->university_transfer) && $aday->educinfo->university_transfer == 'Evet')>Evet
                                                                </option>
                                                                <option value="Hayır"
                                                                    @selected(isset($aday->educinfo->university_transfer) && $aday->educinfo->university_transfer == 'Hayır')>Hayır
                                                                </option>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input
                                                                value="@if(isset($aday->educinfo->university_transfer_desc)) {{$aday->educinfo->university_transfer_desc}} @endif"
                                                                type="text" class="form-control"
                                                                id="university_transfer_desc"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 mb-3">
                                                            <label for="languages">Bildiğiniz diller nelerdir? Seviyeleri
                                                                ...
                                                                yazınız</label>
                                                            <input
                                                                value="@if(isset($aday->educinfo->languages)) {{$aday->educinfo->languages}} @endif"
                                                ...
                                                <div id="lisansdiv" class="educdiv d-none">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                <label for="university_class">{{$period->title}} Öğretim
                                                                    Yılında Kaçıncı Sınıfta
                                                                    Olacaksınız?</label>
                                                                <select id="university_class" class="form-select">
                                                                    <option selected disabled value="">Seçiniz...</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == 'Hazırlık')
                                                                        value="Hazırlık">Hazırlık</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '1.Sınıf')
                                                                        value="1.Sınıf">1.Sınıf</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '2.Sınıf')
                                                                        value="2.Sınıf">2.Sınıf</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '3.Sınıf')
                                                                        value="3.Sınıf">3.Sınıf</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '4.Sınıf')
                                                                        value="4.Sınıf">4.Sınıf</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '5.Sınıf')
                                                                        value="5.Sınıf">5.Sınıf</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_class) && $aday->educinfo->university_class == '6.Sınıf')
                                                                        value="6.Sınıf">6.Sınıf</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                <label for="university_educ_time">Öğrenim Gördüğünüz Bölüm
                                                                    Kaç Senelik Eğitim Veriyor? (Hazırlık Dahil)</label>
                                                                <select id="university_educ_time" class="form-select">
                                                                    <option value="">Seçiniz...</option>
                                                                    <option
                                                                        @selected(isset($aday->educinfo->university_educ_time) && $aday->educinfo->university_educ_time == '4')
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <select id="agno_type" class="form-select">
                                                                    <option value="">Seçiniz...</option>
                                                                    <option @selected(isset($aday->educinfo->agno_type) && $aday->educinfo->agno_type == "4'lük") value="4'lük">
                                                                        4'lük</option>
                                                                    <option @selected(isset($aday->educinfo->agno_type) && $aday->educinfo->agno_type == "100'lük")
                                                                        value="100'lük">100'lük</option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <select id="university_transfer" class="form-select">
                                                                    <option value="">Seçiniz...</option>
                                                                    <option value="Evet"
                                                                        @selected(isset($aday->educinfo->university_transfer) && $aday->educinfo->university_transfer == 'Evet')>
                                                                        Evet</option>
                                                                    <option value="Hayır"
                                                                        @selected(isset($aday->educinfo->university_transfer) && $aday->educinfo->university_transfer == 'Hayır')>
                                                                        Hayır</option>
                                                    ...
                                                    <div id="yukseklisansdiv" class=" educdiv d-none">
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                <label for="grade_university">Bitirdiğiniz
                                                                    Üniversite</label>
                                                                <input @if(isset($aday->educinfo->grade_university))
                                                                value="{{$aday->educinfo->grade_university}}" @endif
                                                                    type="text" class="form-control" id="grade_university"
                                                                    placeholder="Üniversite bilgisi giriniz...">
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="grade_departmant">Mezun Olduğunuz Bölüm</label>
                                                                <input type="text"
                                                                    @if(isset($aday->educinfo->grade_departmant))
                                                                    value="{{$aday->educinfo->grade_departmant}}" @endif
                                                                    class="form-control" id="grade_departmant"
                                                                    placeholder="Puanınızı giriniz...">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                <label for="university_city">Üniversitenin Bulunduğu
                                                                    Şehir</label>
                                                                <select id="university_city" class="form-select">
                                                                    <option selected disabled value="seçiniz">Seçiniz..
                                                                    </option>
                                                                    @foreach($cities as $city)
                                                                        <option data-id="{{ $city->id }}" @if(isset($aday->educinfo->university_city) && $aday->educinfo->university_city == $city->isim)
                                                                        selected @endif value="{{$city->isim}}">
                                                                            {{$city->isim}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                <label for="master_field">Yüksek Lisans Yaptığınız
                                                                    Dal</label>
                                                                <input @if(isset($aday->educinfo->master_field))
                                                                value="{{$aday->educinfo->master_field}}" @endif
                                                                    type="text" class="form-control" id="master_field"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                <label for="student_number">Öğrenci Numarası</label>
                                                                <input @if(isset($aday->educinfo->student_number))
                                                                value="{{$aday->educinfo->student_number}}" @endif
                                                                    type="text" class="form-control" id="student_number"
                                                                    placeholder="Öğrenci numaranızı giriniz...">
                                                            </div>
                                                            <div class="col-md-6 mb-3">
                                                                <label for="university_class">Yeni Öğretim Yılında Kaçıncı
                                                                    Sınıfta
                                                                    Olacaksınız?</label>
                                                                <select id="university_class" class="form-select">
                                                                    <option value="">Seçiniz...</option>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                <label for="departmentYear">Öğrenim Gördüğünüz Bölüm Kaç
                                                                    Senelik Eğitim Veriyor? (Hazırlık Dahil)</label>
                                            ...
                                            <div class="tab-section">
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select id="kalınanYerBilgileriBarınmaTürü" class="form-select">
                                                            <option selected disabled value="seçiniz">Seçiniz..</option>
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Ödediğiniz Ücret</label>
                                                        <input id="housing_fee" type="text" class="form-control"
                                                            placeholder="Ödenen ücreti giriniz..">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Birlikte Yaşadığınız Kişi Sayısı</label>
                                        ...
                                        <div class="tab-pane fade" id=" family-address-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Annenizin Yaşadığı İl</label>
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Babanızın Yaşadığı İl</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Annenizin Yaşadığı İlçe</label>
                                                        <select id="mother_district" class="form-select">
                                                            <option selected disabled value="seçiniz">Seçiniz..</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Babanızın Yaşadığı İlçe</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label" for="phone">Ailenin Cep Telefonu</label>
                                                        <br>
                                                        <input type="tel" id="phone" class="form-control telinputs"
                                                            placeholder="+90 501 123 5288" style="width:390px ; ">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Ailenin Ev Telefonu</label>
                                        ...
                                        <div class="tab-pane fade" id="parent-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Anneniz ve Babanız Birlikte mi?</label>
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Anneniz Sağ mı?</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Anneninizin Soyadı</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Babanız Sağ mı?</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Annenizin Mesleği</label>
                                                        <input id="mother_job" type="text" class="form-control"
                                                            placeholder="Anne meslek giriniz...">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Babanızın Mesleği</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Annenizin Tahsil Durumu</label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <input id="educ_count" type="number" class="form-control"
                                                            placeholder="Okuyan kardeş sayısını giriniz..">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="other-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                ...
                                                <table class="table table-striped" id="bursTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Burs</th>
                                                            <th>Kurum Türü</th>
                                                            <th>Çalıştığınız Kurumun Adı</th>
                                                            <th> Burs Tutarı</th>
                                                            <th>Seçenekler</th>
                                                        </tr>
                                                    </thead>
                                            ...
                                            <div class="tab-section">
                                                <div class="row">
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <select id="disableddetail" class="form-select">
                                                            <option selected disabled>Seçiniz...</option>
                                                            <option value="Evet">Evet</option>
                                                            <option value="Hayır">Hayır</option>
                                                        </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 form-group">
                                                        <label class="custom-label">Engel Durumunu Açıklayınız
                                                            (Varsa)</label>
                                                        <input id="disabledstatus" type="text" class="form-control"
                                        ...
                                        <div class="tab-pane fade" id="social-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">İlgilendiğiniz Spor Dalı Var ise
                                                            Açıklayınız</label>
                                        ...
                                        <div class="tab-pane fade" id="job-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Çalıştığınız Kurumun Adı</label>
                                                        <input id="company" type="text" class="form-control"
                                                            placeholder="Kurum adı giriniz..">
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Göreviniz</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Bağlı Bulunduğunuz Sosyal Güvenlik
                                                            Kurumu</label>
                                                        <select class="form-select" id="sgk">
                                                            <option value="SGK">SGK</option>
                                                            <option value="BAĞ-KUR">BAĞ-KUR</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                        <label class="custom-label">Aylık Net Ücretiniz</label>
                                                        <input id="salary" type="text" class="form-control" value="100">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                ...
                                                                @foreach($belgeler as $doc)
                                                                    ...
                                                                    <div class="col-md-3 col-sm-6">
                                                                        <div class="upload-card">
                                                                            ...
                                                                            <div id="{{$doc->db_key}}"
                                                                                data-id="{{$doc->db_key}}" class="delete-icon">
                                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <form id="interviewForm">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="stepinterviewer"
                                                                    placeholder="Yazınız...">
                                                            </div>
                                                            <div class="col-md-12 form-group">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button class="btn" data-bs-toggle="modal"
                                                                        data-bs-target="#updateInterviewModal">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="17"
                                                                            height="17" viewBox="0 0 17 17" fill="none">
                                                                            <path
                                                                                d="M4.5434 11.2552L11.7274 4.07118L10.7257 3.06944L3.54167 10.2535V11.2552H4.5434ZM5.1302 12.6719H2.125V9.66662L10.2248 1.56684C10.5015 1.29022 10.9499 1.29022 11.2265 1.56684L13.23 3.57031C13.5066 3.84693 13.5066 4.29542 13.23 4.57204L5.1302 12.6719ZM2.125 14.0885H14.875V15.5052H2.125V14.0885Z"
                                                                                fill="#4069E5" />
                                                                        </svg>
                                                                    </button>
                                                                    <button class="btn" data-bs-toggle="modal"
                                                    ...
                                                    <ul class="timeline-member">
                                                        <li class="timeline-item-member">
                                                            ...
                                                            <div class="timeline-content-member">
                                                                <p>Canan Tan, "Aidat Geçmişi" ve "Adli Sicil Belgesi" isimli
                                                                    2
                                                                    adet
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="p-2 timeline-content-doc">
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ml-2">
                                                                                <span>Adli Sicil Belgesi</span><br>
                    ...
                    <div class="transfer-modal-footer d-flex justify-content-end g-3 ">
                        <button type="button" class="btn cancel-button" id="prevStep"
                            onclick="location.href='/panel/Aday-Bursiyerler'">Vazgeç</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editSiblingForm">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="kardesMedeniDurumuz" class=" form-label">Medeni Durum</label>
                                    <select class="form-select" id="kardesMedeniDurumu" required>
                                        <option disabled>Seçiniz...</option>
                                        <option>Bekar</option>
                        ...
                        <form id="addBursForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="bursMıktarı"
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select id="redSebebi" class="form-select">
                                <option selected>Ret sebebini seçiniz</option>
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <select id="ıadeSebebi" class="form-select">
                                <option selected disabled>İade sebebini seçiniz</option>
        ...
        <div class="modal fade" id="newStudentWarningModal" tabindex="-1" aria-labelledby="newStudentWarningModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        Öğrenci henüz yeni eklendiği için mülakat oluşturulamaz.
                    </div>
                    <div class="d-flex">
    ...
    @section('scripts')
        ...
        @include('panel.student-forms.select-type')
        <script>
