...
@endsection
                ...
                <div class=" mt-1">
                                        ...
                                        <div class="profile-details">
                                            ...
                                            <p><strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        ...
                                                        <path
                                                            d="M8.33942 1.7531C7.1714 1.375 5.90172 1.90093 5.34318 2.99418L4.67169 4.30849C4.59191 4.46465 4.46489 4.59166 4.30873 4.67144L2.99442 5.34293C1.90117 5.90147 1.37525 7.17116 1.75334 8.33914L2.20789 9.74331C2.2619 9.91014 2.2619 10.0898 2.20789 10.2566L1.75334 11.6608C1.37525 12.8288 1.90118 14.0985 2.99442 14.657L4.30873 15.3285C4.46489 15.4083 4.59191 15.5353 4.67169 15.6915L5.34318 17.0057C5.90172 18.099 7.17141 18.6249 8.33942 18.2468L9.74359 17.7923C9.91042 17.7383 10.09 17.7383 10.2568 17.7923L11.661 18.2468C12.829 18.6249 14.0988 18.099 14.6573 17.0057L15.3288 15.6915C15.4085 15.5353 15.5355 15.4083 15.6917 15.3285L17.006 14.657C18.0993 14.0985 18.6252 12.8288 18.2471 11.6608L17.7925 10.2566C17.7385 10.0898 17.7385 9.91014 17.7925 9.74331L18.2471 8.33914C18.6252 7.17115 18.0993 5.90147 17.006 5.34293L15.6917 4.67144C15.5355 4.59166 15.4085 4.46464 15.3288 4.30849L14.6573 2.99418C14.0988 1.90093 12.829 1.375 11.661 1.7531L10.2568 2.20764C10.09 2.26165 9.91042 2.26165 9.74359 2.20764L8.33942 1.7531ZM6.82736 3.75244C7.01354 3.38803 7.43677 3.21273 7.8261 3.33875L9.23025 3.7933C9.73075 3.95533 10.2697 3.95533 10.7702 3.7933L12.1743 3.33875C12.5637 3.21273 12.9869 3.38803 13.1731 3.75244L13.8446 5.06676C14.0839 5.53524 14.4649 5.91628 14.9334 6.15563L16.2478 6.82711C16.6122 7.01329 16.7875 7.43652 16.6614 7.82585L16.2069 9.23006C16.0448 9.73056 16.0448 10.2694 16.2069 10.7699L16.6614 12.1741C16.7875 12.5634 16.6122 12.9866 16.2478 13.1728L14.9334 13.8443C14.4649 14.0836 14.0839 14.4647 13.8446 14.9331L13.1731 16.2475C12.9869 16.6119 12.5637 16.7872 12.1743 16.6611L10.7702 16.2066C10.2697 16.0446 9.73075 16.0446 9.23025 16.2066L7.8261 16.6611C7.43677 16.7872 7.01354 16.6119 6.82736 16.2475L6.15588 14.9331C5.91653 14.4647 5.53549 14.0836 5.06701 13.8443L3.75269 13.1728C3.38828 12.9866 3.21297 12.5634 3.339 12.1741L3.79355 10.7699C3.95557 10.2694 3.95557 9.73056 3.79355 9.23006L3.339 7.82585C3.21297 7.43652 3.38828 7.01329 3.75269 6.82711L5.067 6.15563C5.53549 5.91628 5.91653 5.53524 6.15588 5.06676L6.82736 3.75244ZM5.6332 9.79781L9.16875 13.3333L15.0613 7.44077L13.8828 6.26226L9.16875 10.9763L6.81172 8.61923L5.6332 9.79781Z"
                                                            fill="#0052CC" />
                                                    </svg>KY Durumu:</strong> <span class="basvuruDurumu "></span></p>
                                            <p><strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                        viewBox="0 0 20 20" fill="none">
                                                        <path
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                                    ...
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select id="born_city" class="form-select">
                                                            ...
                                                            @foreach($cities as $city)
                                                                <option data-id="{{$city->il_no}}" value="{{$city->name}}">
                                                                    {{$city->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="education-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <select id="primary_educ_type" class="form-select">
                                                                ...
                                                                <option @selected(isset($aday->primary_educ_type) && $aday->primary_educ_type == 'Özel Okul')
                                                                    value="Özel Okul">Özel Okul</option>
                                                                <option @selected(isset($aday->primary_educ_type) && $aday->primary_educ_type == 'Devlet Okulu')
                                                                    value="Devlet Okulu">Devlet Okulu</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <select id="class" class="form-select">
                                                                ...
                                                                <option @selected(isset($aday->class) && $aday->class == '1')
                                                                    value="1">1</option>
                                                                <option @selected(isset($aday->class) && $aday->class == '2')
                                                                    value="2">2</option>
                                                                <option @selected(isset($aday->class) && $aday->class == '3')
                                                                    value="3">3</option>
                                                                <option @selected(isset($aday->class) && $aday->class == '4')
                                                                    value="4">4</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="middle_educ_type" class="form-select">
                                                                <option disabled selected>Seçiniz..</option>
                                                                <option @selected(isset($aday->middle_educ_type) && $aday->middle_educ_type == 'Özel Okul') value="Özel Okul">
                                                                    Özel Okul</option>
                                                                <option @selected(isset($aday->middle_educ_type) && $aday->middle_educ_type == 'Devlet Okulu')
                                                                    value="Devlet Okulu">Devlet Okulu</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                ...
                                                <div id="lisediv" class="educdiv d-none">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="h_school_type">Lise Tipi</label>
                                                            <select id="h_school_type" class="form-select">
                                                                <option disabled selected>Seçiniz..</option>
                                                                <option @selected(isset($aday->h_school_type) && $aday->h_school_type == 'Devlet Lisesi')
                                                                    value="Devlet Lisesi">Devlet Lisesi</option>
                                                                <option @selected(isset($aday->h_school_type) && $aday->h_school_type == 'Özel Lise (Tam burslu)')
                                                                    value="Özel Lise (Tam burslu)">Özel Lise (Tam burslu)
                                                                </option>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="h_school_district" class="form-select">
                                                                <option> @if(isset($aday->educinfo->h_school_district))
                                                                {{$aday->educinfo->h_school_district}} @endif </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div id="lisansdiv" class="educdiv d-none">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="university_city" class="form-select">
                                                                <option selected disabled value="seçiniz">Seçiniz..</option>
                                                                @foreach($cities as $city)
                                                                    <option data-id="{{ $city->id }}" @if(isset($aday->educinfo->university_city) && $aday->educinfo->university_city == $city->name) selected
                                                                    @endif value="{{$city->name}}">{{$city->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="current_university" class="form-select">
                                                                ...
                                                                @foreach($unis as $u)
                                                                    <option data-id='{{$u->id}}'
                                                                        @selected(isset($aday->current_university) && $aday->current_university == $u->name)
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="university_faculty">Fakülte</label>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            <label for="university_class">{{$period->title}} Öğretim Yılında
                                                                Kaçıncı Sınıfta
                                                                Olacaksınız?</label>
                                                            ...
                                                            <select id="oKN3UeDifPTo" class="form-select">
                                                                <option selected disabled value="">Seçiniz...</option>
                                                                <option @selected(isset($aday->educinfo->oKN3UeDifPTo) && $aday->educinfo->oKN3UeDifPTo == '1.Sınıf')
                                                                    value="1.Sınıf">1.Sınıf</option>
                                                                <option @selected(isset($aday->educinfo->oKN3UeDifPTo) && $aday->educinfo->oKN3UeDifPTo == '2.Sınıf')
                                                                    value="2.Sınıf">2.Sınıf</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mb-3">
                                                        <label for="languages">Bildiğiniz diller nelerdir? Seviyeleri ile
                                                            birlikte
                                                            yazınız</label>
                                                        <input
                                                ...
                                                <div id="yukseklisansdiv" class=" educdiv d-none">
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            <label for="grade_university">Öğrenime Devam Ettiğiniz
                                                                Üniversite</label>
                                                            <select id="grade_university" class="form-select">
                                                                <option value="">Seçiniz...</option>
                                                                @foreach($unis as $u)
                                                                    <option data-id='{{$u->id}}'
                                                                        @selected(isset($aday->grade_university) && $aday->grade_university == $u->name) value="{{$u->name}}">
                                                                        {{$u->name}}</option>
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" @if(isset($aday->educinfo->grade_departmant))
                                                            value="{{$aday->educinfo->grade_departmant}}" @endif
                                                                class="form-control" id="grade_departmant"
                                                                placeholder="Mezun Olduğunuz Bölüm giriniz...">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <select id="master_university" class="form-select">
                                                                @foreach($unis as $u)
                                                                    <option data-id='{{$u->id}}'
                                                                        @selected(isset($aday->master_university) && $aday->master_university == $u->name)
                                                                        value="{{$u->name}}">{{$u->name}}</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            value="{{$aday->educinfo->master_field}}" @endif type="text"
                                                                class="form-control" id="master_field"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 form-group">
                                                        ...
                                                        <select id="housing_type" class="form-select">
                                                            ...
                                                            <option value="Arkadaş Yanı">Arkadaş Yanı</option>
                                        ...
                                        <div class="tab-pane fade" id="sibling-info" role="tabpanel"
                                            ...
                                            <div class="tab-section">
                                                ...
                                                <button id="addButton" type="button" class="btn btn-primary mb-3"
                    ...
                    <div class="transfer-modal-footer d-flex justify-content-end g-3 ">
                        <button type="button" class="btn cancel-button" id="prevStep"
                            onclick="location.href='{{route('kayityenileme')}}'">Vazgeç</button>
                    ...
                    <div class="modal-body">
                        ...
                        <form id="addSiblingForm">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <button type="button" class="btn btn-primary" id="kardesEkleSubmitBtn">Ekle</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="modal-body">
                        <form id="addBursForm">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                ...
                                <button type="button" class="btn btn-primary" id="bursEkleSubmitBtn">Ekle</button>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    @section('scripts')
        ...
        <script src="{{url('')}}/assets/js/income.js"></scrix1pt >
                <script>
            ...
            (allBursTipleri || [])
                .filter(tip => tip && (tip.ogrenim_tipi === educationType || tip.ogrenim_tipi === 'tumu'))
                .forEach(tip => {
            ...
            document.addEventListener('DOMContentLoaded', function () {
                refreshBursTipleri();
                const edu = document.getElementById('educationType');
                if (edu) edu.addEventListener('change', refreshBursTipleri);
            });
        </script>
        <script>
            let kardesler = [];
            ...
            function closeModal(modalId) {
                ...
                // Bootstrap modal instance'ını da temizle
            ...
            function openModal(modalId) {
                ...
                // Tüm modal instance'larını temizle
                $('.modal').each(function () {
            ...
            // Burs ekleme/düzenleme işlemi
            $(document).on('click', '#bursEkleSubmitBtn', function () {
                const $btn = $(this);
                ...
                iziToast.success({
                    title: 'Başarılı',
                    message: 'Burs başarıyla eklendi',
                    position: 'topRight'
                });
                // Kısa gecikme ile yeniden etkinleştir (çift tıklama/yarış durumlarını engelle)
                setTimeout(() => { $btn.prop('disabled', false); }, 500);
            });

            // Global modal temizlik ve backdrop koruması
            $(document).ready(function () {
                ...
                // Periyodik temizlik
                setInterval(globalModalCleanup, 2000);
            ...
            $(document).ready(function () {
                $('#kardesEkleBtn').on('click', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                    editingKardesIndex = null;
                    $('#addSiblingForm')[0].reset();
                    setTimeout(() => openModal('kardesEkleModal'), 100);
                });

                $('#bursEkleBtn').on('click', function (e) {
                    e.preventDefault();
                    e.stopPropagation();
                    editingBursIndex = null;
                    $('#addBursForm')[0].reset();
                    setTimeout(() => openModal('bursEkleModal'), 100);
                });
            ...
            // Kardeş ekleme/düzenleme işlemi
            $(document).on('click', '#kardesEkleSubmitBtn', function (e) {
                e.preventDefault();
                e.stopPropagation();
                ...
                $btn.prop('disabled', true);
                const $modal = $('#kardesEkleModal');

                const kardesData = {
                    ad: $modal.find('#kardesAdi').val(),
                    soyad: $modal.find('#kardesSoyadi').val(),
                    yas: $modal.find('#kardesYasi').val(),
                    ogrenimDurumu: $modal.find('#kardesOgrenimDurumu').val(),
                    medeniDurum: $modal.find('#kardesMedeniDurumu').val(),
                    meslek: $modal.find('#kardesMeslegi').val()
                };
            ...
            function submitForm(redirectUrl = null) {
                ...
                // AJAX isteği
                $.ajax({
                    url: '{{route('manuel-bursiyer-ekle-post')}}',
                    type: 'POST',
                    data: formData,
            ...
            document.getElementById('p_school_city').addEventListener('change', function () {
                var districtSelectId = 'mp_school_district'; // İlçelerin yükleneceği select elementinin ID'si
                getDistricts(this, districtSelectId);
            });
            ...
            if (faculty !== null) {
                faculty.addEventListener('change', function () {
                    ...
                    var dataId = selectedOption.getAttribute('data-id'); // Seçili option'ın data-id'sini al
                    getDepartmants(faculty, 'department');
        ...
        <script>
            ...
            // Dosya yükleme işlemi için tick ekleme fonksiyonu
            function updateFileUploadUI(fileInput, file) {
                ...
                // Label içeriğini güncelle ve tick ikonu ekle
            ...
            function initializeDragDrop() {
                ...
                dropAreas.forEach(dropArea => {
                    ...
                    // Change event listener'ı ekle (hem drag & drop hem de normal dosya seçimi için)
                    ...
                    dropArea.addEventListener('drop', function (e) {
                        ...
                        if (files.length > 0) {
                            ...
                            // Change event'ini tetikle (bu otomatik olarak tick ekleme işlemini yapacak)
