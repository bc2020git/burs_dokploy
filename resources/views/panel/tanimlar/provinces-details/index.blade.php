...
@section('body')
    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            ...
            <div class="btn-toolbar  mb-md-0">
                ...
                <div class="dropdown-export">
                    ...
                    <ul class="dropdown-menu " id="export-menu" aria-labelledby="export">
                        <li><a class="dropdown-item" href="#">
                                <img src="{{url('')}}/assets/images/pdf.svg" alt="PDF" width="24" height="24">
                                PDF olarak aktar
                            </a></li>
                        <li><a class="dropdown-item" href="#">
                                <img src="{{url('')}}/assets/images/excel.svg" alt="Excel" width="24" height="24">
                                Excel dosyasında aktar
                            </a></li>
                        <li><a class="dropdown-item" href="#">
                                <img src="{{url('')}}/assets/images/word.svg" alt="Word" width="24" height="24">
                                Word dosyasında aktar
                            </a></li>
                        <li><a class="dropdown-item" href="#">
                                <img src="{{url('')}}/assets/images/csv.svg" alt="CSV" width="24" height="24">
                                .csv olarak aktar
                            </a></li>
                    </ul>
                </div>
                ...
                <a href="{{route('delete-province',['id'=> $province->id])}}">
                ...
                <button type="button" class="btn btn-outline-primary me-3" onclick="location.reload();" id="reload" data-bs-toggle="tooltip"
        ...
        <main class="main-content px-3 py-4">
            <div class="container mt-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form id="provinceDetailForm" class="p-4">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <input type="hidden" name="id"  id="id" value="{{$province->id}}">
                                    <label for="plakaNo" class="custom-label">İl Plaka No</label>
                                    <input value="{{$province->il_no}}" name="il_no" type="text" class="form-control" id="il_no">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="ilAd" class="custom-label">İl Adı</label>
                                    <input value="{{$province->name}}" name="name" type="text" class="form-control" id="name">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">İlkokul'da İle Burs Veriliyor Mu?</label>
                                    <select id="bv_ilkokul" class="form-select">
                                        <option @if($province->bv_ilkokul ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_ilkokul ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Ortaokul'da İle Burs Veriliyor Mu?</label>
                                    <select id="bv_ortaokul" class="form-select">
                                        <option @if($province->bv_ortaokul ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_ortaokul ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Lise'de İle Burs Veriliyor Mu?</label>
                                    <select id="bv_lise" class="form-select">
                                        <option @if($province->bv_lise ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_lise ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Ön Lisans'ta İle Burs Veriliyor Mu?</label>
                                    <select id="bv_onlisans" class="form-select">
                                        <option @if($province->bv_onlisans ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_onlisans ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Lisans'ta İle Burs Veriliyor Mu?</label>
                                    <select id="bv_lisans" class="form-select">
                                        <option @if($province->bv_lisans ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_lisans ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Yüksek Lisans'ta İle Burs Veriliyor Mu?</label>
                                    <select id="bv_yukseklisans" class="form-select">
                                        <option @if($province->bv_yukseklisans ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_yukseklisans ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Doktora'da İle Burs Veriliyor Mu?</label>
                                    <select id="bv_doktora" class="form-select">
                                        <option @if($province->bv_doktora ==1) selected @endif  value="1">Evet</option>
                                        <option @if($province->bv_doktora ==0) selected @endif  value="0">Hayır</option>
                                    </select>
                                </div>
                            </div>
                        </form>
    ...
    @section('scripts')
        ...
        <script src="{{url('')}}/assets/js/components/scholarmodal.js"></script>
            @include('panel.tanimlar.provinces-details.scriptf')
