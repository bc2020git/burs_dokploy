...
@endsection
    @section('content')
                ...
                <div class="navbar-button-container">
                    <div class="d-flex flex-wrap">
                        <button type="button" class="btn me-3 text-white" id="newAdd" data-bs-toggle="tooltip"
                            ...
                            onclick="window.location.href='{{route('add-departmants')}}'">
        ...
        @include('panel.tanimlar.departmants.modals')
    @endsection
    @section('scripts')
        <!-- App js -->
        ...
        @include('panel.tanimlar.departmants.scriptf')
        ...
        <script>
            ...
            function islemIcinDiziGonder(islemid) {
                ...
                $.ajax({
                    url: '{{route('delete_multiple_departmants')}}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        ids: selectedIds,
