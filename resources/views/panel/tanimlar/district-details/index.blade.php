...
@section('body')
        ...
        <main class="main-content px-3 py-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
                ...
                <div class="btn-toolbar  mb-md-0">
                    ...
                    <a href="{{route('delete-district',['id'=> $data->id])}}">
            ...
            <div class="container mt-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form id="districtDetailForm" class="p-4">
                            <div class="row">
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="isim" class="custom-label">İl Adı</label>

                                    <select id="il_no" class="form-select">
                                        <option selected disabled value="">İl No Seçiniz..</option>
                                        @foreach($provinces as $province)
                                            <option @if($data->il_no ==$province->id) selected @endif value="{{ $province->il_no }}">{{ $province->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 form-group">
                                    <label for="isim" class="custom-label">İlçe Adı</label>
                                    <input type="text" value="{{$data->isim}}" class="form-control" id="isim">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">İlkokul'da İlçeye Burs Veriliyor Mu?</label>
                                    <select id="bv_ilkokul" class="form-select">
                                        <option @if($data->bv_ilkokul ==1) selected @endif value="1">Evet</option>
                                        <option @if($data->bv_ilkokul ==0) selected @endif value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Ortaokul'da İlçeye Burs Veriliyor Mu?</label>
                                    <select id="bv_ortaokul" class="form-select">
                                        <option @if($data->bv_ortaokul ==1) selected @endif value="1">Evet</option>
                                        <option @if($data->bv_ortaokul ==0) selected @endif value="0">Hayır</option>
                                    </select>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="custom-label">Lise'de İlçeye Burs Veriliyor Mu?</label>
                                    <select id="bv_lise" class="form-select">
                                        <option @if($data->bv_lise ==1) selected @endif value="1">Evet</option>
                                        <option @if($data->bv_lise ==0) selected @endif value="0">Hayır</option>
                                    </select>
                                </div>
                            </div>
                        </form>
    ...
    @section('scripts')
        ...
        <script src="{{url('')}}/assets/js/components/scholarmodal.js"></script>
            @include('panel.tanimlar.district-details.scriptf')
