...
@section('body')
        ...
        <main class="main-content px-3 py-4">
            <div class="container mt-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form action="{{route('store-bank')}}" id="bankDetailForm" method="post" enctype="multipart/form-data" > @csrf

                                <div class="row">
                                <div class="col-md-12 form-group">
                                    <label for="bankaAdi" class="custom-label">Banka Adı</label>
                                    <input id="bankaAdi" name="bankaAdi" type="text" class="form-control" placeholder="Banka adı giriniz">
                                </div>
                                <div class="col-md-12 form-group">
                                    <div class="col-md-12 form-group">
                                        <label for="bankaKodu" class="custom-label">Banka Kodu</label>
                                        <input id="bankaKodu" name="bankaKodu" type="number" class="form-control" placeholder="Banka kodu giriniz">
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    @section('scripts')
        ...
        @include('panel.tanimlar.banks.scriptf')
