    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            ...
            <div class="btn-toolbar  mb-md-0">
                ...
                <a href="{{route('delete-bank',['id'=>$bank->id])}}">
                        ...
                        <form id="bankDetailForm"  class="p-4">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    ...
                                    <label for="bankaAdi" class="custom-label">Banka Adı</label>
                                    <input id="bankaAdi" name="bankaAdi" type="text" class="form-control" value="{{$bank->bank_name}}">
                                </div>
                                <div class="col-md-12 form-group">
                                    <div class="col-md-12 form-group">
                                        <label for="bankaKodu" class="custom-label">Banka Kodu</label>
                                        <input id="bankaKodu" name="bankaKodu" type="number" class="form-control" value="{{$bank->bank_code}}">
                                    </div>
                                </div>
                            </div>
                        </form>
...
<script>
    $(document).ready(function() {
        function submitForm(redirectUrl = null) {
            // Form verilerini al
            let formData = {};
            var bankaid = document.getElementById('id').value;
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        iziToast.success({
                            ...
                            message: 'Banka Güncellendi', // Assuming response.success contains the success message
