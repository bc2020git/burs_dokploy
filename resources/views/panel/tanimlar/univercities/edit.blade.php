    ...
    @section('content')
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ">
            ...
            <div class="btn-toolbar  mb-md-0">
                ...
                <a href="{{route('delete-univercity',['id'=>$data->id])}}">
        ...
        <main class="main-content px-3 py-4">
            <div class="container mt-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form id="universityDetailForm" class="p-4">
                            <div class="row">
                                <div class="col-md-12 form-line">
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <label for="code" class="custom-label">Üniversite Kodu</label>
                                        <input id="code" name="code" type="number" class="form-control"  value="{{$data->code}}" placeholder="Üniversite kodu giriniz">                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="custom-label">Üniversite Adı</label>
                                        <input id="name" name="name" type="text" class="form-control"  value="{{$data->name}}" placeholder="Üniversite adı giriniz">
                                    </div>
                                    <div class="form-group">
                                        <label for="universiteTuru" class="custom-label">Üniversite Türü</label>
                                        <select class="form-control" id="universiteTuru">
                                            <option   @if($data->type=='Devlet') Selected @endif value="Devlet">Devlet</option>
                                            <option   @if($data->type=='Özel') Selected @endif value="Özel">Özel</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="sehir">
                                                @foreach($cities as  $city)
                                                    <option @if($data->city  == $city->name) selected @endif value="{{$city->name}}">
                                                        {{$city->name}}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Ön Lisans'ta Üniversiteye Burs Veriliyor Mu?</label>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Lisans'ta Üniversiteye Burs Veriliyor Mu?</label>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Yüksek Lisans'ta Üniversiteye Burs Veriliyor Mu?</label>
                                        ...
                                        <label class="custom-label">Doktora'da Üniversiteye Burs Veriliyor Mu?</label>
    ...
    @section('scripts')
        ...
        <script>
            function submitForm(redirectUrl = null) {
                // Form verilerini al
                let formData = {};
                document.querySelectorAll(`#universityDetailForm input, #universityDetailForm select, #universityDetailForm textarea`).forEach(input => {
                    formData[input.id] = input.value;
                });
                // AJAX isteği
                $.ajax({
                    url: '{{route('update-univercity')}}',
                    type: 'POST',
                    data: {
                        formData: formData,
            ...
            $('#kaydetVeKapatBtn').click(function() {
                submitForm('/panel/Universiteler');
            });
