                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form id="universityDetailForm" class="p-4">
                            <div class="row">
                                <div class="col-md-12 row  form-line">
                                    <h3 class="mb-3">Üniversite Bilgileri</h3>
                                    <div class="col-md-12 form-group">
                                        <label for="code" class="custom-label">Üniversite Kodu</label>
                                        <input id="code" name="code" type="text" class="form-control" placeholder="Üniversite kodu giriniz">                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="custom-label">Üniversite Adı</label>
                                        <input id="name" name="name" type="text" class="form-control" placeholder="Üniversite adı giriniz">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Ön Lisans'ta Burs Veriliyor Mu?</label>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Lisans'ta Burs Veriliyor Mu?</label>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Yüksek Lisans'ta Burs Veriliyor Mu?</label>
                                    ...
                                    <div class="col-md-6 form-group">
                                        <label class="custom-label">Doktora'da Burs Veriliyor Mu?</label>
