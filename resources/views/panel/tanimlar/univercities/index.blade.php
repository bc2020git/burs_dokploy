...
@endsection
                ...
                <div class="navbar-button-container">
                    <div class="d-flex flex-wrap">
                        <button type="button" class="btn me-3 text-white" id="newAdd" data-bs-toggle="tooltip"
                                ...
                                onclick="window.location.href='{{route('add-univercities')}}'">
    ...
    @section('scripts')
        ...
        @include('panel.tanimlar.univercities.scriptf')
        ...
        <script>
            ...
            function generateActions(id) {
                return `
                    <a href="/panel/Universite-Detay/${id}">
        ...
        <script>
            function islemIcinDiziGonder(islemid) {
                ...
                $.ajax({
                    url: '{{route('delete_multiple_univercities')}}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        ids: selectedIds,
            ...
            $('#waste').on('click', function() {
                ...
                if (checkboxes.length === 0) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Uyarı',
                        text: 'Lütfen silinecek üniversiteleri seçin!',
                ...
                Swal.fire({
                    title: 'Emin misiniz?',
                    text: 'Üniversite ve üniversiteye bağlı tüm fakülteler ve bölümler de silinecektir',
                    icon: 'warning',
