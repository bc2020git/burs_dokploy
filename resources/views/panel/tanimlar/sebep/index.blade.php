...
@section('body')
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="createInterviewModalLabel">Sebep Oluştur</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <p class="title">Sebep bilgilerini giriniz</p>
                        <p class="small">Oluştur butonuna bastığınızda sebep eklenecektir.</p>
                        <form method='post' action='{{route('sebep.store')}}'  id="createInterviewForm"> @csrf
                            <div class="mb-3">
                                <label for="type" class="custom-label">Sebep Tipi</label>
                                <select required id="type" name="type" class="form-select">
                                    <option selected disabled value="">Sebep Tipini Seçiniz</option>
                            ...
                            <div class="mb-3">
                                <label for="text" class="form-label">Sebep Metni </label>
                                <input required name='text' type="text" class="form-control" id="text"
                                       placeholder="Sebep metni giriniz..">
                            </div>
    ...
    @section('scripts')
        ...
        @include('panel.tanimlar.sebep.scriptf')
