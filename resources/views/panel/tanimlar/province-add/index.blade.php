...
@section('body')
                        ...
                        <form id="provinceDetailForm" class="p-4">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <label class="custom-label">İl Plaka No</label>
                                    <input id="il_no" type="number" class="form-control" placeholder="İl Plaka No giriniz..">
                                </div>
                                <div class="col-md-12 form-group">
                                    <label class="custom-label">İl Adı</label>
                                    <input id="name" type="text" placeholder="İl Adı giriniz.." class="form-control">
                                </div>
    ...
    @section('scripts')
        ...
        <script src="{{url('')}}/assets/js/components/scholarmodal.js"></script>
            @include('panel.tanimlar.province-add.scriptf')
