<script>
    ...
    const url = "{{ route('burs-tipleri.edit', ['id' => ':id']) }}".replace(':id', candidateId);
...
<script>
    ...
    $(document).ready(function() {
                ...
                render: function(data, type, row) {
                    if (type === 'display' && column.visible === true) {
                        switch(column.name) {
                            ...
                            case 'ogrenim_tipi':
                                return getEducationType(row.ogrenim_tipi);
                            default:
        ...
        dtColumns.push({
            ...
            searchable: false,
            render: function(data, type, row) {
                var url = "{{ route('burs-tipleri.edit', ['id' => ':id']) }}".replace(':id', row.id);
                if (type === 'display') {
                    return `
