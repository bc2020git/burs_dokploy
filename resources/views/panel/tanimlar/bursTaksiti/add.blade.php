...
@section('body')
        ...
        <main class="main-content px-3 py-4">
            <div class="container mt-3">
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form id="bursTaksitDetailForm" method="post" enctype="multipart/form-data"> @csrf

                                <div class="row">
                                <div class="col-md-12 form-group mb-3">
                                    <label for="burs_tipi_id" class="custom-label">Burs Tipi</label>
                                    <select name="burs_tipi_id" id="burs_tipi_id" class="form-select" required>
                                ...
                                <div class="col-md-6 form-group mb-3">
                                    ...
                                    <input type="number" name="burs_tutari" id="burs_tutari" class="form-control" min="0" step="0.01" placeholder="0.00" required>
                                </div>
                                <div class="col-md-6 form-group mb-3">
                                    <label for="taksit_sayisi" class="custom-label">Taksit Sayısı</label>
                                    <input type="number" name="taksit_sayisi" id="taksit_sayisi" class="form-control" min="1" value="1" required>
                                </div>
                                <div class="col-md-6 form-group mb-3">
                                    <label for="baslangic_tarihi" class="custom-label">Başlangıç Tarihi</label>
                                    <input type="text" name="baslangic_tarihi" id="baslangic_tarihi" class="form-control" autocomplete="off" required>
                                </div>
                            </div>
                        </form>
    ...
    @section('scripts')
        ...
        @include('panel.tanimlar.bursTaksiti.scriptf')
