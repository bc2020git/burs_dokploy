...
@section('body')
                ...
                <div class="navbar-button-container">
                    <div class="d-flex flex-wrap">
                        <button type="button" class="btn me-3 text-white" id="newAdd" data-bs-toggle="tooltip"
                                ...
                                onclick="window.location.href='{{route('add-district')}}'">
                    ...
                    <div class="navbar-button-container">
                        ...
                        <x-export-buttons table-id="districtTable" model="district" />
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="schooltype" value="ilkokul"
                                                   id="ilkokul">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="schooltype" value="ortaokul"
                                                   id="ortaokul">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="schooltype" value="lise"
                                                   id="lise">
    ...
    @section('scripts')
        ...
        @include('panel.tanimlar.districts.scriptf')
        ...
        <script src="{{url('')}}/assets/js/components/scholarmodal.js"></script>
            ...
            console.log('=================================');
            console.log('🎯 DISTRICTS PAGE DEBUG START');
            console.log('=================================');

            // Immediate test
            console.log('📋 Table found:', document.getElementById('districtTable') ? 'YES' : 'NO');
            console.log('🔧 Dynamic export function available:', typeof initializeDynamicExport);
            console.log('🎛️ Export buttons found:', document.querySelectorAll('.export-action').length);
            console.log('✅ CSRF token:', document.querySelector('meta[name="csrf-token"]') ? 'YES' : 'NO');
            console.log('🌐 Window location:', window.location.href);

            // Test interval to check loading
            let checkCount = 0;
            const checkInterval = setInterval(function() {
                checkCount++;
                console.log(`⏰ Check #${checkCount}:`);
                console.log('  🔧 Dynamic export function:', typeof initializeDynamicExport);
                console.log('  🎛️ Export buttons:', document.querySelectorAll('.export-action').length);
                console.log('  📋 Table:', document.getElementById('districtTable') ? 'EXISTS' : 'MISSING');
                ...
                if (typeof initializeDynamicExport === 'function' && document.querySelectorAll('.export-action').length > 0) {
                    clearInterval(checkInterval);
                    console.log('✅ Everything ready! Initializing...');

                    // DataTables butonlarını da kontrol et
                    console.log('🔍 Checking DataTables buttons:');
                    console.log('  📊 Global table variable:', typeof table);
                    console.log('  🎯 DataTables instance:', $('#districtTable').length && $.fn.DataTable.isDataTable($('#districtTable')));
                    console.log('  🔘 Export buttons in DOM:', document.querySelectorAll('.buttons-excel, .buttons-pdf, .buttons-csv').length);
                    console.log('  🆔 Legacy buttons:', {
                        excel: document.getElementById('excelButton') ? 'EXISTS' : 'MISSING',
                        pdf: document.getElementById('pdfButton') ? 'EXISTS' : 'MISSING',
                        csv: document.getElementById('csvButton') ? 'EXISTS' : 'MISSING'
                    });

                    initializeDynamicExport('districtTable');
                }
            }, 500);
        </script>
...
<script>
    $(document).ready(function() {
            ...
            function islemIcinDiziGonder(islemid) {
                ...
                $.ajax({
                    url: '{{route('delete-multiple-district')}}',
                    method: 'POST',
                    data: {
                        _token: '{{ csrf_token() }}',
                        ids: selectedIds,
