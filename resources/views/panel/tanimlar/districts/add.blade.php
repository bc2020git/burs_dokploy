                    ...
                    <div class="card-body">
                        <form id="provinceDetailForm" class="p-4">
                            <div class="row">
                                ...
                                <select id="il_no_select" class="form-select">
                                    <option selected disabled value="">İl Seçiniz..</option>
                                    @foreach($provinces as $province)
                                        <option value="{{ $province->il_no }}">{{ $province->name }}</option>
                                    @endforeach
                                </select>
                                </div>
                                ...
                                <div class="col-md-12 form-group">
                                    <label class="custom-label">İlçe Adı</label>
                                    <input id="isim" name="isim" type="text" class="form-control" value="">
                                </div>
...
<script>
    ...
    let ilNoSelect = document.getElementById('il_no_select');
                        ...
                        success: function(response) {
                            ...
                            if(response.success){
                                ...
                                iziToast.error({
                                    ...
                                    message: 'İlce Adı Kayıtlı!', // Assuming response.success contains the success message
                                });
                            }
