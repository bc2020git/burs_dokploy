                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{ route('message-template.store') }}" method="POST" id="createForm">
                                    @csrf
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="ri-save-line"></i> Oluştur
                                        </button>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="hidden" id="parameters" name="parameters" form="createForm">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function addParameter() {
                console.log('addParameter function called');
                const container = document.getElementById('parameters-container');
                console.log('Parameters container found:', container);
                ...
                if (container) {
                    ...
                    console.log('New parameter item added');
                    updateParametersInput();
                } else {
