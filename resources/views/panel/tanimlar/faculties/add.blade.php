...
@section('body')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fakulteKodu" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="custom-label">Fakülte Adı</label>
                                        <input type="text" name="name" class="form-control" id="name" placeholder="Fakülte Adı Giriniz">
                                    </div>
                                    <div class="col-md-12 form-group">
    ...
    @section('scripts')
        ...
        <script src="{{url('')}}/assets/js/tables/facultys.js"></script>
