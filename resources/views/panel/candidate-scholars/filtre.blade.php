...
$dataurl = route('aday.data');
$tableColumns = '';
$checkboxInitiliazer = <<<'JS'
    return '<input type="checkbox" name="userCheckbox" class="form-check-input user-checkbox" data-id="' + row.id + '" value="' + row.id + '"  data-name="' + row.name + '" data-surname="' + row.surname + '" data-tel="' + row.tel_no + '" data-email="' + row.email + '">';
JS;
@endphp
