                ...
                <form method='post' action='{{ route('listnewinterview') }}' id="createInterviewForm"> @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <input name="date" type="date" class="form-control date-input" id="interviewDate"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input name="address" type="text" class="form-control" id="meetingLink"
                                placeholder="Yazınız..">
                        </div>
                        <div class="col-md-12 form-group">
...
<div class="modal fade" id="saveInterviewModal" tabindex="-1" aria-labelledby="saveInterviewModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
...
<!-- Uyarı Modali -->
<div class="modal fade" id="interviewWarningModal2" tabindex="-1" aria-labelledby="interviewWarningModalLabel2"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Çoklu Uyarı Modali -->
<div class="modal fade" id="multipleSelectionModal" tabindex="-1" aria-labelledby="multipleSelectionModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
        ...
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <select id="iadeSebebi" class="form-select" required>
                        <option value="" selected disabled>İade sebebini seçiniz</option>
                ...
                <textarea id="iadeDigerAciklama" class="form-control" rows="3" placeholder="Açıklama giriniz..."></textarea>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body w-100">
                ...
                <form action="{{ route('toplu-mulakat-ata') }}" method="post" id="mulakatAtaForm"> @csrf
                    ...
                    <button type="submit" class="btn btn-primary" id="mulakatAtaOnayBtn">Mülakat Ata</button>
