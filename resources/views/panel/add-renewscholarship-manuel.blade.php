...
@section('title')
    Yeni Kayıt Yenileme Bursiyeri Ekle
@endsection
@section('page-title')
    Yeni Kayıt Yenileme Bursiyeri Ekle
@endsection
                                                                                ...
                                                                                <label for="{{$dbKey}}"
                                                                                    ...
                                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                                        ...
                                                                                        <path
                                                                                            ...
                                                                                            fill="#2D3648"></path>
                                                                                        <path
                                                                                            d="M3.33073 13.3334C3.33073 12.8732 2.95763 12.5001 2.4974 12.5001C2.03716 12.5001 1.66406 12.8732 1.66406 13.3334V15.8334C1.66406 16.4965 1.92745 17.1323 2.3963 17.6012C2.86514 18.07 3.50102 18.3334H6.66406C7.1243 18.3334 7.4974 17.9603 7.4974 17.5001C7.4974 17.0398 7.1243 16.6667 6.66406 16.6667H4.16406C3.94305 16.6667 3.73109 16.5789 3.57481 16.4227C3.41853 16.2664 3.33073 16.0544 3.33073 15.8334V13.3334Z"
                                                                                            fill="#2D3648"></path>
                                                                                        <path
