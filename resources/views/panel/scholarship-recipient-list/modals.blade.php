...
<!-- Bursiyer Tipi Güncelle Modal -->
<div class="modal fade" id="bursiyerTipGuncelleModal" tabindex="-1" aria-labelledby="bursiyerTipGuncelleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body w-100 text-center">
                <i style="font-size: 40px;color: var(--bs-primary-text-emphasis);" class="fas fa-info-circle"></i>
                <h5 class="my-3">Bursiyer Tipi Güncellensin mi?</h5>
                <p>Aşağıdan bursiyer tipini seçiniz.</p>
                <select class="form-select" id="bursiyerTipiModalSelect">
                    <option value="Boş">Boş</option>
                    <option value="Dernek">Dernek</option>
                    <option value="Vakıf">Vakıf</option>
                </select>
                <p>Bursiyer tipi güncellenecektir. Bu işlemi onaylıyor musunuz?</p>
                <div class="d-flex justify-content-center mt-3">
                    <button type="button" class="btn btn-secondary me-3" data-bs-dismiss="modal"> Vazgeç</button>
                    <button type="button" class="btn btn-outline-primary" id="bursiyerTipGuncelleOnayBtn" data-bs-dismiss="modal">
