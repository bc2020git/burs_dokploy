        ...
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <select id="disabled_status" class="form-select">
                    <option @if($aday->disabled_status == 'Evet') selected @endif  value="Evet">Evet</option>
                    <option @if($aday->disabled_status == 'Hayır') selected @endif value="Hayır">Hayır</option>
                </select>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <input id="disabled_detail" type="text" class="form-control" value="{{$aday->disabled_detail}}">
            </div>
        </div>
    </div>
</div>
