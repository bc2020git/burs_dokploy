        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select class="form-select" id="platform" required>
                    ...
                    <option @if($aday->platform == 'Sosyal Medya') selected @endif value="Sosyal Medya">Sosyal Medya</option>
                    <option @if($aday->platform == 'Web Sitesi') selected @endif value="Web Sitesi">Web Sitesi</option>
                    <option @if($aday->platform == 'Diğer') selected @endif value="Diğer">Diğer</option>
                </select>
            </div>
            <div class="col-md-6 form-group">
                <label class="custom-label">Güçlü Yanlarınızın Ne olduğunu
                    Düşünüyorsunuz?</label>
                <input id="skills" type="text" class="form-control" value="{{$aday->skills}}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 form-group">
