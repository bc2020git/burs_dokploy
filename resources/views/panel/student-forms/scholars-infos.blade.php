        ...
        <div class="row">
            <div class="col-md-6 form-group">
                ...
                <select id="government" class="form-select">
                    <option @if($aday->government == 'Evet') selected @endif  value="Evet">Evet</option>
                    <option @if($aday->government == 'Hayır') selected @endif value="Hayır">Hayır</option>
                </select>
            </div>
            <div class="col-md-6 form-group">
                <label class="custom-label">Özel Burs Almakta ya da Başvurdu mu?</label>
                <select id="special" class="form-select">
                    <option @if($aday->special == 'Evet') selected @endif  value="Evet">Evet</option>
                    <option @if($aday->special == 'Hayır') selected @endif value="Hayır">Hayır</option>
                </select>
            </div>
        </div>
