                            ...
                            <div class="step-content" id="step-8" data-content="8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="kira"
                                               placeholder="Kişi bilgisi giriniz...">
                                    </div>
                                </div>
                                <div class="row">
    ...
    @section('scripts')
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                const employmentStatus = document.getElementById("employment-status") || document.getElementById("is_working");
                const employmentDetails = document.getElementById("employment-details");

                if (employmentStatus && employmentDetails) {
                    employmentStatus.addEventListener("change", function () {
                        if (this.value === "full-time" || this.value === "part-time" || this.value === "intern" || this.value === "Full-time" || this.value === "Part-time" || this.value === "Stajyer") {
