  ...
  const students = [
    {
      ...
      id: "001",
      bursBaslangic: "2018-2019",
      ad: "Canan",
      soyad: "Tan",
      okulAdi: "Ortaokul",
      sinif:"4. Sınıf",
      bolum: "Mühendislik",
      bursDurumu: "Aktif Bursiyerler",
    },
    {
      profil: "/assets/images/avatar-correct.svg",
      id: "002",
...
$("#graduateTable tbody").on("click", "tr", function () {
  window.location.href = "/admin/active-scholarship-details.html";
});

$("#graduateTable tbody").on("click", "td:nth-child(11), input[type='checkbox']", function (e) {
  e.stopPropagation();
});
