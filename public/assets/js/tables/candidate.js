document.addEventListener("DOMContentLoaded", function () {
  const candidates = [
    {
      ...
      id: "001",
      tcKimlikNo:"26548974632",
      ad: "Canan",
      soyad: "Tan",
      telefonNo: "555 555 5555",
    ...
    },
    {
      ...
      basvuruDurumu: "Mülakat Bekliyor",
      ogrenimturu: "İlkokul",
    },
    {
      profil: "/assets/images/avatar-correct.svg",
    ...
    },
    {
      ...
      ad: "kadir",
      soyad: "Witting",
      telefonNo: "555 666 3333",
      basvuruDurumu: "Mülakat Bekliyor",
      ogrenimturu: "Ön Lisans",
    },
    {
      profil: "/assets/images/avatar-correct.svg",
      id: "009",
  ...
  candidates.forEach((candidate) => {
    ...
    const rowInnerHTML = `
                ...
                <td>${candidate.id}</td>
                <td>${candidate.tcKimlikNo}</td>
                <td>${candidate.ad}</td>
                <td>${candidate.soyad}</td>
                <td>${candidate.telefonNo}</td>
                <td><span class="${getBadgeClass(candidate.basvuruDurumu)}">${candidate.basvuruDurumu}</span></td>
                <td>${candidate.ogrenimturu}</td>
