...
class LisansrenewForm extends Model
{
    protected $guarded = [];
    ...
    public $table = 'lisansrenew_forms';

    public function scholar()
    {
        return $this->hasOne(Lisansscholar::class, 'id', 'scholar_id');
    }

    public function infos()
    {
        return $this->hasOne(LisansrenewAnswer::class, 'form_id', 'id');
    }
