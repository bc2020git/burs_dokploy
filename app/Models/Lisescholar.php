...
class Lisescholar extends Authenticatable
{
    ...
    public $table = 'lisescholars';

    public function form()
    {
        return $this->hasMany(LisescholarForm::class, 'scholar_id', 'id');
    }

    public function renewform()
    {
        return $this->hasMany(LiserenewForm::class, 'scholar_id', 'id');
