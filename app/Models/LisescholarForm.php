...
class LisescholarForm extends Model
{
    protected $guarded = [];
    ...
    {
        return $this->hasOne(LisescholarDocuments::class, 'form_id', 'id');
    }

    public function infos()
    {
        return $this->hasOne(LiseactiveAnswer::class, 'form_id', 'id');
    }

    public function educinfo()
    {
        return $this->hasOne(LiseactiveEducationalInfo::class, 'form_id', 'id');
    }
