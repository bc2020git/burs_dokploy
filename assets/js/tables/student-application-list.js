document.addEventListener("DOMContentLoaded", function () {
    const candidates = [
      ...
      },
      {
        ...
        basvurudonemi: "2022-2023"
      },
    ];
  
    const studentApplicationTableBody = document.getElementById("studentApplicationTableBody");
    ...
    row.addEventListener("click", function () {
      window.location.href = "/student/application-form-middle.html";
    });
    ...
    studentApplicationTableBody.appendChild(row);
  });
